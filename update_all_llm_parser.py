...
def update_all_parse_job_description():
    ...
    updated_content = re.sub(old_pattern, new_method, content)
    
    with open('agents/cover_letter_agent.py', 'w') as f:
        f.write(updated_content)
    
    print("Updated all parse_job_description methods to use LLM parser")

if __name__ == "__main__":
    update_all_parse_job_description() 