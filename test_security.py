...
class TestSecurityManager:
    ...
    def test_validate_secret_format(self):
        ...
        assert self.security_manager.validate_secret_format(
...
class TestEnvironmentConfig:
    ...
    def test_validate_config_invalid_api_key(self):
        ...
        config = {"openai_api_key": "invalid-key", "google_credentials_file": "credentials.json"}
        ...
        try:
            ...
            with patch("agents.gap_analysis.openai.OpenAI"):
                extract_requirements_llm(
                    "test job description", "sk-test123456789012345678901234567890123456789012345678901234567890"
                )
