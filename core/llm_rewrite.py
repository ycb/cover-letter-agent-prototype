...
class LLMRewriter:
    ...
    def rewrite_cover_letter(
        self, original_text: str, job_description: str, user_context: Optional[Dict[str, Any]] = None
    ) -> str:
        """
        ...
        try:
            ...
            prompt = self._create_rewrite_prompt(original_text, job_description, context_text)
    ...
    def _create_rewrite_prompt(self, original_text: str, job_description: str, context_text: str) -> str:
...
<!-- End LLM Enhanced Cover Letter -->"""
    ...
    def validate_truth_preservation(self, original_text: str, enhanced_text: str) -> Dict[str, Any]:
        """
        ...
        exaggeration_patterns = ["led a team of", "managed", "oversaw", "directed", "spearheaded"]
...
def post_process_with_llm(
    first_draft: str, job_description: str, user_config: Dict[str, Any], user_context: Optional[Dict[str, Any]] = None
) -> str:
    """
    ...
    # Perform the rewrite
    enhanced_draft = rewriter.rewrite_cover_letter(first_draft, job_description, user_context)
